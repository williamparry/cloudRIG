...
function start(cb) {
	...
	if(settings.fromBase) {
		...
		startFunctions = startFunctions.concat([
			...
			// TODO: Set initial launch with -silent for updating
			// TODO: Install shortcut for creds
			...
			(instance, cb) => {
				...
				sendMessage(getPS1("Install-Sound-Driver.ps1"), () => { cb(null, instance); });
			},
