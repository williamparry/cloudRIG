...
function deleteSpotRequest(spotInstanceRequestId, cb) {
	...
	reporter.report("Deleting spot request");
	...
	var _request = function(cb) {
		...
		ec2.runInstances({
			...
			*/
			...
			if(instance.StateReason.Message == "Server.InsufficientInstanceCapacity" || instance.StateReason.Message == "Server.InternalError") {
