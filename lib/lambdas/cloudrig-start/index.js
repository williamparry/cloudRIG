exports.handler = (event, context, callback) => {
	...
	var snsArnPrefix = "arn:aws:sns:" + eventBody.config.AWSRegion + ":" + eventBody.settings.UserID + ":";
	...
	function checkState() {
		ec2.describeInstances(
			...
			function(err, data) {
				...
				if (data.Reservations[0] && data.Reservations[0].Instances && data.Reservations[0].Instances.length > 0) {
